...
if(ageGroup %in% c("05to09","10to14","15to19f", "15to19m")){
  source("./src/data-prep/prep-chinadsp.R")
}
...
if(ageGroup == "05to09"){
  source("./src/data-prep/prep-measles.R")
}
...
# Currently, the covariates are included in the model-input object. Need the code that was used to select them.
...
source("./src/prediction/extract-cov-hmm.R")
source("./src/prediction/extract-cov-lmm.R")
source("./src/prediction/functions_prediction.R")
source("./src/prediction/predict-csmf-hmm.R")
source("./src/prediction/predict-csmf-lmm.R")
