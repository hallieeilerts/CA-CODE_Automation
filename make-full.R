...
source(src/data-prep/prep-igme.R)
source(src/data-prep/prep-chinadsp.R)
source(src/data-prep/prep-chinanmch.R)

################################################
# Estimation
################################################

source(src/estimation/prep-model-input.R)
#source(src/estimation/select-covariates.R)
source(src/estimation/create-parameter-grid.R)
source(src/estimation/select-parameters-formal.R)
source(src/estimation/run-model.R)
