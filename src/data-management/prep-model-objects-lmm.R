################################################################################
#' @description Re-save model fit with standardized name
...
#' @return Vector with names of covariates used in the age/sex-specific model. 
################################################################################
#' Libraries
#' Inputs
...
saveRDS(vxf, file = paste("./gen/estimation/output/mod_covNames_", ageGroup, "LMM.rds",sep=""))
